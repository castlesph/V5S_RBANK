...
//			memcpy(transData->szAmount1, sqlite3_column_blob(stmt,inStmtSeq +=1 ), 7);						
...
int inLocalAP_Database_BatchUpdate(TRANS_DATA_TABLE *transData)
{
	...
	result = sqlite3_bind_blob(stmt, inStmtSeq +=1, transData->szCVV2, 6, SQLITE_STATIC);
...
//	result = sqlite3_bind_blob(stmt, inStmtSeq +=1, transData->szAmount1, 7, SQLITE_STATIC);
